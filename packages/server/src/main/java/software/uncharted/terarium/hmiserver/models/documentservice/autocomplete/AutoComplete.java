...
public class AutoComplete implements Serializable {
  ...
  /**
   * Looks at the underlying objects returned by XDD and determines if there are any auto complete
   * suggestions. This is a convenience method meant to make returning error codes cleaner.
   *
