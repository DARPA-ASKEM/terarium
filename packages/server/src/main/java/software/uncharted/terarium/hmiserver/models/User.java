...
public class User implements UserDetails {
  @Serial private static final long serialVersionUID = 2359680472757828388L;
  ...
  @Transient @TSIgnore Collection<SimpleGrantedAuthority> authorities;

  @Transient @JsonIgnore @TSIgnore private String password = "";

  @Transient @JsonIgnore @TSIgnore private boolean accountNonExpired = true;

  @Transient @JsonIgnore @TSIgnore private boolean accountNonLocked = true;

  @Transient @JsonIgnore @TSIgnore private boolean credentialsNonExpired = true;
