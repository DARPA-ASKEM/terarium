...
public class DecapodesContextService {
  ...
  public Optional<DecapodesContext> getDecapodesContext(UUID id) throws IOException {
    DecapodesContext doc =
        elasticService.get(
            elasticConfig.getDecapodesContextIndex(), id.toString(), DecapodesContext.class);
  ...
  public DecapodesContext createDecapodesContext(DecapodesContext decapodesContext)
      throws IOException {
  ...
  public Optional<DecapodesContext> updateDecapodesContext(DecapodesContext decapodesContext)
    ...
    if (!elasticService.contains(
        elasticConfig.getDecapodesContextIndex(), decapodesContext.getId().toString())) {
      return Optional.empty();
    }
