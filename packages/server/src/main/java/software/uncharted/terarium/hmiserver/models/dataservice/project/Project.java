...
public class Project extends TerariumAsset implements Serializable {
  ...
  @Serial private static final long serialVersionUID = -241733670076432802L;
  ...
  /**
   * Information for the front-end to enable/disable features based on user permissions
   * (Read/Write).
   */
  @TSOptional
  @Transient
