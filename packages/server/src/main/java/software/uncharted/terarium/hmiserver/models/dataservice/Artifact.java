...
/**
 * Represents a generic artifact that can be stored in the data service. For example, this could be
 * a text file, a code file, a zip file, or anything else. It should not be used for a dataset or a
...
public class Artifact extends TerariumAsset {
  @Serial private static final long serialVersionUID = -1122602270904707476L;
  ...
  @TSOptional private List<OntologyConcept> concepts;
}
