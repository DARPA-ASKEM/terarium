...
public interface EventRepository extends PSCrudRepository<Event, String> {
	List<Event> findAllByTypeAndProjectIdAndUserIdAndValueLike(final EventType type, final UUID projectId, final String userId, final String like, Pageable pageable);
	...
	List<Event> findAllByTypeAndProjectIdAndUserId(final EventType type, final UUID projectId, final String userId, Pageable pageable);
