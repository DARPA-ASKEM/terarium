...
public class DocumentAsset extends TerariumAsset {
  ...
  @Serial private static final long serialVersionUID = -8425680186002783351L;
  ...
  @TSOptional private HashMap<String, Object> metadata;

  @TSOptional private String source;

  @TSOptional private String text;

  @TSOptional private Grounding grounding;

  @TSOptional private List<OntologyConcept> concepts;

  @TSOptional private List<DocumentExtraction> assets;
