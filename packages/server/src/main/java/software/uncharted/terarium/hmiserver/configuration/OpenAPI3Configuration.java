...
@OpenAPIDefinition(servers = { @Server(url = "http://localhost:8080")}, info = @Info(title = "Terarium APIs", description = "This lists all the Pantera API Calls. The Calls are OAuth2 secured, "
