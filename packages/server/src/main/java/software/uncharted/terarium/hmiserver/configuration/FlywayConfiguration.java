...
/**
 * This configuration class ensures that hibernate runs BEFORE flyway. This is to preserve the
 * schema generation provided by Hibernate, but still get the benefits of having a proper version
...
public class FlywayConfiguration {
  ...
  /**
   * Set the baseline version to be the latest script. In the case where flyway is not initialized,
   * we assume hibernate correctly sets up the database
   */
  @Bean
  ...
  FlywayVoid delayedFlywayInitializer(
      final Flyway flyway, final FlywayProperties flywayProperties) {
