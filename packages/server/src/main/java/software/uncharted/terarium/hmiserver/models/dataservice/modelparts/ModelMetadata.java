...
public class ModelMetadata extends SupportAdditionalProperties implements Serializable {
  @Serial private static final long serialVersionUID = 1847034755264399454L;
  ...
  @TSOptional private Annotations annotations;

  @TSOptional private List<JsonNode> attributes;

  @TSOptional private Map<String, Object> timeseries;

  @TSOptional private Map<String, Object> initials;

  @TSOptional private Map<String, Object> parameters;

  @TSOptional private Card card;
  ...
  @TSOptional private List<String> provenance;
