...
public class Dataset extends TerariumAsset {
  ...
  @Serial private static final long serialVersionUID = 6927286281160755696L;
  ...
  @TSOptional private String esgfId;
  ...
  /**
   * (Optional) Url from which the dataset can be downloaded/fetched TODO: IS THIS NEEDED? IS THIS
   * FROM OLD TDS? https://github.com/DARPA-ASKEM/terarium/issues/3194
   */
  @TSOptional
  ...
  /**
   * (Optional) List of urls from which the dataset can be downloaded/fetched. Used for ESGF
   * datasets
   */
  @TSOptional private List<String> datasetUrls;

  /** Information regarding the columns that make up the dataset */
  @TSOptional private List<DatasetColumn> columns;

  /** (Optional) Unformatted metadata about the dataset */
  @TSOptional private JsonNode metadata;

  /** (Optional) Source of dataset */
  @TSOptional private String source;

  /** (Optional) Grounding of ontological concepts related to the dataset as a whole */
  @TSOptional private Grounding grounding;
}
