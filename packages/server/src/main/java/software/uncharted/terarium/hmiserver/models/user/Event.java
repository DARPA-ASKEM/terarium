...
public class Event implements Serializable {
  @Serial private static final long serialVersionUID = 7337142167492880031L;

  @Id @TSOptional private String id = UUID.randomUUID().toString();

  @Column(nullable = false)
  @TSOptional
  private Long timestampMillis = Instant.now().toEpochMilli();

  @TSOptional private UUID projectId;
