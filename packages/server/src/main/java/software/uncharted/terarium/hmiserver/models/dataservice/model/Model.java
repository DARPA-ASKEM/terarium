...
public class Model extends TerariumAssetThatSupportsAdditionalProperties {
  ...
  @Serial private static final long serialVersionUID = 398195277271188277L;
  ...
  @TSOptional private JsonNode properties;

  @TSOptional private ModelSemantics semantics;

  @TSOptional private ModelMetadata metadata;
  ...
  public List<Initial> getInitials() {
    ...
    if (this.isRegnet()) {
      return objectMapper.convertValue(
          this.getModel().get("initials"), new TypeReference<List<Initial>>() {});
    } else {
