...
public class CsvAsset implements Serializable {
  ...
  @Serial private static final long serialVersionUID = -3242849061655394707L;
  ...
  @TSOptional List<CsvColumnStats> stats;

  /** Headers on this CSV file */
  List<String> headers;

  /**
   * The number of rows in the CSV file. This may be a larger value than the csv object contained
   * within
   */
  Integer rowCount;
