 ...
 * jackson to serialize and deserialize the object.
 *
 * This causes unwanted behavior for classes that we specifically override to
 * behave a particular way with jackson. Ex. classes that extend
...
public class HypersistenceJsonSerializerSupplier implements JsonSerializerSupplier {
	...
	static public class HypersistenceJsonSerializer implements JsonSerializer {
		...
		public <T> T clone(final T object) {
			if (object instanceof String) {
				...
				if (firstElement != null) {
					final JavaType type = TypeFactory.defaultInstance().constructParametricType(object.getClass(),
