...
public class MultipartFileService {
   ...
   *
   * <p>NOTE: The body of getItemIterator can only be executed once. If you need to access the
   * metadata of the form on a per-field basis (eg/ to get the content type of a file) you will need
   * to use the JakartaFileUpload directly or refactor this method to return a custom model that
