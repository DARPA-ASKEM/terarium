...
public class HttpUtil {
  ...
  public static HttpClient getHttpClient() {
    if (httpClient == null) {
      if (sslsf != null) {
        httpClient =
            HttpClientBuilder.create().useSystemProperties().setSSLSocketFactory(sslsf).build();
      } else {
  ...
  public static void setSkipCertificateValidation() {
    if (!tlsWarningEmitted.getAndSet(true)) {
      ...
      log.error(
          "The tool will skip certificate validation. This is highly discouraged for production use"
              + " cases");
    }
  ...
  public static void doPostJSON(String resourceUrl, String auth, Object content) {
    ...
    try {
      response =
          HttpUtil.doRequest(
              "post", resourceUrl, new HeadersBody(headers, new ByteArrayInputStream(body)));
    } catch (IOException e) {
      throw new RuntimeException(
  ...
  public static void doDeleteJSON(String resourceUrl, String auth, Object content) {
    ...
    try {
      response =
          HttpUtil.doRequest(
              "delete", resourceUrl, new HeadersBody(headers, new ByteArrayInputStream(body)));
    } catch (IOException e) {
      throw new RuntimeException(
