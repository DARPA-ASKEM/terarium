...
public class ModelService extends TerariumAssetService<Model> {
  ...
  public Optional<ModelDescription> getDescription(final UUID id) throws IOException {
    final ModelDescription md =
        ModelDescription.fromModel(
  ...
  public List<Model> searchModels(
      final Integer page, final Integer pageSize, final JsonNode queryJson) throws IOException {
    Query query = null;
    if (queryJson != null) {
      ...
      query =
          new Query.Builder()
              .bool(
                  b ->
                      b.must(new Query.Builder().withJson(new ByteArrayInputStream(bytes)).build())
        ...
        new SearchRequest.Builder()
            ...
            .sort(
                new SortOptions.Builder()
                    .field(new FieldSort.Builder().field("updatedOn").order(SortOrder.Asc).build())
                    .build())
            .build();
  ...
  public List<Model> getAssets(final Integer page, final Integer pageSize) throws IOException {
    throw new UnsupportedOperationException(
        "Not implemented. Use ModelService.searchModels instead");
  }
