...
public class ProvenanceController {
  ...
  @Autowired ProvenanceService provenanceService;

  @Autowired ProvenanceSearchService provenanceSearchService;
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "204",
            description = "There was no provenance found",
            content = @Content),
        @ApiResponse(
            responseCode = "500",
  ...
  public ResponseEntity<Provenance> getProvenance(@PathVariable("id") UUID id) {
    ...
    if (provenance.isEmpty()) {
      throw new ResponseStatusException(
          HttpStatus.NOT_FOUND, String.format("Provenance %s not found", id));
    }
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "404",
            description = "Provenance could not be found",
            content = @Content),
        @ApiResponse(
            responseCode = "500",
            description = "An error occurred while deleting",
