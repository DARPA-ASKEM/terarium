...
public class ProvenanceControllerTests extends TerariumApplicationTests {
  ...
  public void testItCanGetProvenance() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.get("/provenance/" + provenance.getId()).with(csrf()))
  ...
  public void testItCanSearchProvenanceConnectedNodes() throws Exception {
    ...
    ProvenanceQueryParam payload =
        new ProvenanceQueryParam()
            .setRootId(modelId)
    ...
    ProvenanceSearchResult results =
        objectMapper.readValue(
            res.getResponse().getContentAsString(), ProvenanceSearchResult.class);
  ...
  public void testItCanSearchProvenanceModelsFromCode() throws Exception {
    ...
    ProvenanceSearchResult resultsA =
        objectMapper.readValue(
            resA.getResponse().getContentAsString(), ProvenanceSearchResult.class);
    ...
    ProvenanceSearchResult resultsB =
        objectMapper.readValue(
            resB.getResponse().getContentAsString(), ProvenanceSearchResult.class);
  ...
  public void testItCanDeleteProvenance() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.delete("/provenance/" + provenance.getId()).with(csrf()))
        .andExpect(status().isOk());
