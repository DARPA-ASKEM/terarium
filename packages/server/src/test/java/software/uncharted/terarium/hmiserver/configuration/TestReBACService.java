...
public class TestReBACService extends ReBACService {
  ...
  void init() {
    ...
    for (User user : USERS) {
      ...
      PermissionUser permissionUser =
          new PermissionUser(
              user.getId(), user.getGivenName(), user.getFamilyName(), user.getEmail(), roles);
    ...
    for (User user : USERS) {
      PermissionUser permissionUser =
          new PermissionUser(
              user.getId(), user.getGivenName(), user.getFamilyName(), user.getEmail());
  ...
  public void createRelationship(
      SchemaObject who, SchemaObject what, Schema.Relationship relationship)
  ...
  public List<UUID> lookupResources(
      SchemaObject who, Schema.Permission permission, Schema.Type type) throws Exception {
