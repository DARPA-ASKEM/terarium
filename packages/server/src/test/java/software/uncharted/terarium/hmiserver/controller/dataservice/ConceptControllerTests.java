...
public class ConceptControllerTests extends TerariumApplicationTests {
  ...
  public void testItCanCreateConcept() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/concepts")
                .with(csrf())
  ...
  public void testItCanGetConcept() throws Exception {
    ...
    final OntologyConcept concept =
        conceptService.createConcept(new OntologyConcept().setCurie("something"));

    mockMvc
        .perform(MockMvcRequestBuilders.get("/concepts/" + concept.getId()).with(csrf()))
  ...
  public void testItCanFacetSearchConcepts() throws Exception {
    ...
    final MvcResult res =
        mockMvc
            .perform(
                MockMvcRequestBuilders.get("/concepts/facets")
    ...
    final ConceptFacetSearchResponse response =
        objectMapper.readValue(
            res.getResponse().getContentAsString(), ConceptFacetSearchResponse.class);
  ...
  public void testItCanSearchConcepts() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.get("/concepts").param("curie", "something").with(csrf()))
        .andExpect(status().isOk())
        .andReturn();
  }
  ...
  public void testItCanDeleteConcept() throws Exception {
    ...
    mockMvc
        .perform(MockMvcRequestBuilders.delete("/concepts/" + concept.getId()).with(csrf()))
        .andExpect(status().isOk());
