...
export default defineComponent({
	...
	methods: {
		isExpanded(datacube: XDDArticle) {
			return this.expandedRowId === datacube.title;
		},
		updateExpandedRow(datacube: XDDArticle) {
			this.expandedRowId = this.expandedRowId === datacube.title ? '' : datacube.title;
		},
