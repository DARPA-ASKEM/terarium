...
/**
 * The Uncharted theme for Vega Charts
 * Uses the vega-themes PowerBi theme as a starting point:
 * https://github.com/vega/vega-themes/blob/main/src/theme-powerbi.ts
 */
...
const fontStandard = '"Figtree", sans-serif'; // Segoe UI';
const fontTitle = fontStandard; // 'wf_standard-font, helvetica, arial, sans-serif';
const defaultBarFillColour = '#858D9D';
export const hoverBarFillColour = '#DADEE3'; // Primevue bluegray-100
...
const unchartedVegaTheme: Config = {
...
export default unchartedVegaTheme;
