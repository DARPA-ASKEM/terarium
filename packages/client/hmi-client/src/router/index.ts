...
import CompareExperiment from '@/views/CompareExperiment.vue';
...
export enum RoutePath {
	...
	CompareExperimentPath = '/compare-experiment',
...
const routes = [
	...
	{ path: RoutePath.CompareExperimentPath, component: CompareExperiment },
