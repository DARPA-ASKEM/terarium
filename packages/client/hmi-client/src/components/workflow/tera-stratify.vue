...
import TeraStrataModelDiagram from '@/components/model/petrinet/tera-strata-model-diagram.vue';
import TeraTypedModelDiagram from '@/components/model/petrinet/tera-typed-model-diagram.vue';
import TeraStratifyOutputModelDiagram from '@/components/model/petrinet/tera-stratify-output-model-diagram.vue';
