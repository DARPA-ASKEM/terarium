...
public class ElasticUpdateService extends ConcurrentWorkerService {
  ...
  public <Input extends IInputDocument, Output extends IOutputDocument>
      List<String> updateDocuments(ElasticIngestParams params, IElasticPass<Input, Output> ingest)
        ...
        (List<Input> items, Long timeWaitingOnQueue) -> {
          try {
            ...
            ElasticsearchService.BulkOpResponse res =
                esService.bulkUpdate(esConfig.getIndex(params.getOutputIndexRoot()), output);
