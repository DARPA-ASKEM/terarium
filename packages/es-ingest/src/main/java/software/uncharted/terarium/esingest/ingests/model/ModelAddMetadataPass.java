...
@Slf4j
public class ModelAddMetadataPass implements IElasticPass<ModelMetadata, Model> {
  ...
  public IInputIterator<ModelMetadata> getIterator(final ElasticIngestParams params)
      throws IOException {
