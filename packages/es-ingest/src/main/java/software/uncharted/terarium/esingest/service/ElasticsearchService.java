...
public class ElasticsearchService {
  ...
  public void init() {
    ...
    final RestClientBuilder httpClientBuilder =
    ...
    final ElasticsearchTransport transport =
        new RestClientTransport(httpClient, new JacksonJsonpMapper(mapper));
  ...
  /**
   * Returns true if the ES cluster contains the index template with the provided name, false
   * otherwise
   *
  ...
  private boolean putTyped(
      final String name, final String typedJson, final String typeName, final String indexName) {
  ...
  public void delete(final String index, final String id) throws IOException {
    ...
    final DeleteRequest req =
        new DeleteRequest.Builder().index(index).id(id).refresh(Refresh.WaitFor).build();
  ...
  public <Output extends IOutputDocument> BulkOpResponse bulkIndex(String index, List<Output> docs)
    ...
    for (Output doc : docs) {
      ...
      bulkRequest.operations(
          op -> op.index(idx -> idx.index(index).id(doc.getId().toString()).document(doc)));
    }
  ...
  public <Output extends IOutputDocument> BulkOpResponse bulkUpdate(String index, List<Output> docs)
    ...
    for (Output doc : docs) {
      ...
      UpdateOperation<Object, Object> updateOperation =
          new UpdateOperation.Builder<Object, Object>()
              .index(index)
  ...
  @Data
  public static class ScriptedUpdatedDoc {
    String id;
    Map<String, JsonData> params;
  }

  public BulkOpResponse bulkScriptedUpdate(
      String index, String script, List<ScriptedUpdatedDoc> docs) throws IOException {
