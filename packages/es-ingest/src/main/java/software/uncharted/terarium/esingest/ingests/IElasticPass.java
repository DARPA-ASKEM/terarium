...
public interface IElasticPass<
    DocInputType extends IInputDocument, DocOutputType extends IOutputDocument> {
  ...
  public IInputIterator<DocInputType> getIterator(final ElasticIngestParams params)
      throws IOException;
