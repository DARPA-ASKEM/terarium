...
public class RebacGroup {
	...
	public void createOwnerRelationship(SchemaObject schemaObject) throws Exception {
		reBACService.createRelationship(getSchemaObject(), schemaObject, Schema.Relationship.OWNER);
	}
}
